...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		*/
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "adrielj47@gmail.com", "50136359850", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27963323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "adrieljosiasrodrigues@gmail.com", "45526750876", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli1.getTelefones().addAll(Arrays.asList("33724249", "997796516"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834",cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "98777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Jesus", "15", "Sala 80", "Centro", "988122335", cli2, c2);
